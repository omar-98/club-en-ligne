...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Site officiel du Football Club Ait Zeggane. Actualités, matchs, classement et effectif." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "FCAZ — Football Club Ait Zeggane" },
      { name: "twitter:description", content: "Site officiel du Football Club Ait Zeggane. Actualités, matchs, classement et effectif." },
