...
const articles = [
  { id: 1, title: "Victoire écrasante 3-0 contre l'ES Sétif", date: "12 Avr 2026", category: "Match", excerpt: "Une performance magistrale de notre équipe qui domine le match du début à la fin." },
  { id: 2, title: "Nouveau milieu de terrain rejoint le FCAZ", date: "10 Avr 2026", category: "Transfert", excerpt: "Un joueur talentueux arrive avec un contrat de 3 ans pour renforcer l'effectif." },
  ...
  { id: 4, title: "Bilan mi-saison : 2ème place au classement", date: "5 Avr 2026", category: "Saison", excerpt: "Avec 18 victoires en 24 matchs, le FCAZ réalise une saison exceptionnelle." },
  ...
  { id: 6, title: "Match caritatif au profit des enfants", date: "28 Mar 2026", category: "Événement", excerpt: "L'équipe organise un match spécial pour récolter des fonds." },
];
  ...
  return (
    <div className="section-padding">
      <div className="max-w-6xl mx-auto">
        <SectionTitle title="Actualités" subtitle="Toutes les nouvelles du FCAZ" />
